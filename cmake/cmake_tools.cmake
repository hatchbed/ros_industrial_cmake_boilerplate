...
macro(target_cxx_version target)
  ...
  if (ARG_INTERFACE)
    message("target_cxx_version: INTERFACE: ${ARG_VERSION} | CXX_FEATURE_FOUND: ${CXX_FEATURE_FOUND}")
  ...
  elseif(ARG_PUBLIC)
    message("target_cxx_version: PUBLIC:  ${ARG_VERSION} | CXX_FEATURE_FOUND: ${CXX_FEATURE_FOUND}")
    if(CXX_FEATURE_FOUND EQUAL "-1")
  ...
  elseif(ARG_PRIVATE)
    message("target_cxx_version: PRIVATE:  ${ARG_VERSION} | CXX_FEATURE_FOUND: ${CXX_FEATURE_FOUND}")
    if(CXX_FEATURE_FOUND EQUAL "-1")
      set_property(TARGET ${target} PROPERTY CXX_STANDARD ${ARG_VERSION})
      set_property(TARGET ${target} PROPERTY CXX_STANDARD_REQUIRED ON)
      if(WIN32 AND MSVC_VERSION GREATER_EQUAL "1900" AND CMAKE_VERSION LESS 3.10)
